...
export default {
  ...
  theme: {
    extend: {
      colors: {
        // Primary colors
        primary: "#0077B6",          // Bleu moyen
        "primary-light": "#00B4D8",  // Bleu clair des bulles
        "primary-dark": "#003566",   // Bleu foncé du texte OPTIMA
        
        // Secondary colors
        secondary: "#00B4D8",        // Cyan pour "Call"
        "secondary-light": "#48CAE4", // Bleu très clair
        "secondary-dark": "#0096C7",
        
        // Accent
        accent: "#90E0EF",           // Accent très clair
        gray: {
          50: "#F9FAFB",
          100: "#F3F4F6",
          200: "#E5E7EB",
